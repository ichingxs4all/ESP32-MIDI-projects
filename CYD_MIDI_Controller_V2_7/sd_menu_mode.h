...
void drawSDMenuMode() {
  ...
  drawRoundButton(4,   btnY, 150, 28, "FORMAT CARD", THEME_ERROR);
  drawRoundButton(162, btnY, 155, 28, "DEL .-FILES",  THEME_WARNING);
...
void handleSDMenuMode() {
  ...
  // FORMAT CARD button
  if (isButtonPressed(4, btnY, 150, 28)) {
    sdMenuOverlay = SDMENU_CONFIRM_FORMAT;
    drawSDMenuMode();
    return;
  }
  // DEL .-FILES button
  if (isButtonPressed(162, btnY, 155, 28)) {
