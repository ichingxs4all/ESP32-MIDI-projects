...
void drawMenu() {
  ...
  tft.drawCentreString("MIDI CONTROLLER", 160, 10, 4);
  tft.setTextColor(THEME_TEXT_DIM, THEME_SURFACE);
  tft.drawCentreString("Cheap Yellow Display", 160, 30, 2);
  
  // Version number
  tft.setTextColor(THEME_TEXT_DIM, THEME_SURFACE);
  tft.drawString("v0.1c", 280, 37, 1);
